...
<html lang="es" xmlns:og="" xmlns:fb="" class="">
  <head>
      ...
      <meta name="twitter:image" content="img/tt.jpg">
      <meta name="twitter:description" content="Spotify es toda la música que necesitarás.">
                
      <title>Vista general de la cuenta - Spotify</title>
    ...
    <style>
        ...
        #publicidad-mala {
            background-image: linear-gradient(#0E172F, #000000);
        }
    </style>
  </head>
  ...
  <body class="m-hn l-es page-account-overview is-loggedin  reboot  overview-promotion">
    ...
    <div class="wrap">
        ...
        <header id="js-navbar" class="navbar navbar-default navbar-static-top" role="banner">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <button type="button" class="navbar-toggle collapsed" data-toggle="sidepanel" data-target="#navbar-nav" style="opacity: 1;">
                        ...
                        <li class="dropdown alternate hidden-sidepanel">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                <li class="alternate sidepanel-item-small visible-md-block ">
                                  <a href="#" id="nav-link-upgrade" data-ga-category="menu" data-ga-action="upgrade" style="animation-delay: 136ms;">
                                    Mejora tu cuenta
                                  </a>
                                </li>
                            </ul>
        ...
        <div class="outer-content-wrapper">
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="btn-group-inverse">
                            ...
                            <button type="button" class="btn btn-submenu dropdown-toggle" data-toggle="dropdown">
                                ...
                                <span class="icon-chevron-down"></span> Vista general de la cuenta
                            </button>
            ...
            <div class="content-wrapper">
                <div class="container container-jumbotron container-promotion holiday" id="publicidad-mala">
                    <div class="jumbotron jumbotron-hero jumbotron-inverse ">
                        <div class="row">
                            <div class="col-sm-7 col-lg-5 col-lg-offset-1">
                                <h2 class="h1">Música sin</h2>
                                <h2 class ="h1">
                                    límites                    
                                </h2>
                                <p class="terms">
                                    Premium te permite reproducir cualquier canción, en cualquier momento. Incluso puedes escucharlas cuando estés sin conexión. Sin restricciones. Sin anuncios.
                                </p> 
                                <a id="modificar" href="#" class="btn  holiday-btn btn-lg hidden-xs " data-ga-category="Account Pages" data-ga-action="Jumbotron CTA clicked" data-ga-label="promotion" data-event-name="CampaignCallToActionClick" data-event-version="2">
                                        Obtener Premium
                                </a>        
                                <a href="#" class="btn  holiday-btn btn-overview-xs " data-ga-category="Account Pages"  data-ga-action="Jumbotron CTA clicked" data-ga-label="promotion">
                                        Obtener Premium
                                </a>  
                            </div>                 
                            <div class="col-lg-7 col-sm-5">
                                <section style="float:right; ">
                                    <img src="../img/iphone-ddd9e69.png" alt="Telefono" style="width: 300px;">
                                </section>
                            </div>
                    </div>
                </div>
                              ...
                              <div class="content">
                                  <div class="content-top">     
                                      ...
                                      <div class="row">
                                          ...
                                          <div class="col-md-6">
                                              <div class="well card subscription " id="">
                                                <h3 class="product-name">Spotify Free</h3>
                                                <p class="subscription-status subscription-compact">
                                                ...
                                                <a href="#" class="button btn btn-green btn-sm center-block" id="btn-cta-subscription-card" data-ga-category="Account Pages" data-ga-action="Subscription Widget CTA clicked" data-ga-label="upsell-trial_30_days">
                                      ...
                                      <div class="well card " id="">
                                        <h3 class="text-primary">Cierra sesión en todas partes</h3>
                                          <div class="row">
                                            <div class="col-md-6">
    ...
    <script src="extra/account.1b997baea2ea5d389c4f.js.download"></script>


    <script src="extra/gabo-event-tracker.d29aaa7dc6e20f41016b.js.download"></script>

    <script src="extra/signup.5a04ff28d9dd3637b9d7.js.download"></script>
