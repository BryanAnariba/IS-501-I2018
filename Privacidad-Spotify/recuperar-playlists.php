...
<head>
    ...
    <title>Recuperar Playlists -Spotify</title>
...
<body class=" m-hn l-es page-account-recover-playlists is-loggedin  reboot " cz-shortcut-listen="true">
          <noscript>
...
<header id="js-navbar" class="navbar navbar-default navbar-static-top " role="banner">
    ...
    <div class="navbar-header">
          ...
          <span class="icon-bar"></span>
            ...
            <ul class="nav">
        <li class="dropdown">
          <a href="/hn/account/overview/" class="user-link dropdown-toggle hidden-xs hidden-sm" data-toggle="dropdown">
    ...
    <svg class="user-icon">
      <use xlink:href="#user-icon">
          ...
          <a href="/hn/account/overview/" class="user-link hidden-md hidden-lg" data-tracking="{&quot;category&quot;: &quot;menu&quot;, &quot;action&quot;: &quot;account&quot;}">
                                <div class="user-icon-container img-circle navbar-user-img">
    <svg class="user-icon">
      <use xlink:href="#user-icon">
    </use></svg>
          ...
          <ul class="dropdown-menu dropdown-menu-right">
            ...
            <li>
              <a href="/hn/logout/" data-tracking="{&quot;category&quot;: &quot;menu&quot;, &quot;action&quot;: &quot;log-out&quot;}">Cerrar Sesión</a>
            </li>
          </ul>
        </li>
      </ul>
            <a href="/hn/account/overview/" class="user-link hidden">
                            <div class="user-icon-container img-circle navbar-user-img">
    <svg class="user-icon">
      <use xlink:href="#user-icon">
    </use></svg>
...
<li>
  ...
  <li role="separator" class="divider"></li>
    ...
    <a href="/hn/account/overview/" id="nav-link-account" data-ga-category="menu" data-ga-action="account">
      Cuenta
                </a>
  </li>

      <li class="alternate sidepanel-item-small hidden-md hidden-lg ">
    <a href="/hn/logout/" id="nav-link-log-out" data-ga-category="menu" data-ga-action="log-out">
      Cerrar Sesión
                </a>
  </li>
  ...
  <li class="dropdown alternate hidden-sidepanel">
    <a href="/hn/account/overview/" class="user-link dropdown-toggle" data-toggle="dropdown">
                          <div class="user-icon-container img-circle navbar-user-img">
    <svg class="user-icon">
      <use xlink:href="#user-icon">
    </use></svg>
    ...
    <a href="/hn/premium/" id="nav-link-upgrade" data-ga-category="menu" data-ga-action="upgrade">
      ...
      <li>
        <a href="/hn/logout/" class="logout-link" data-tracking="{&quot;category&quot;: &quot;menu&quot;, &quot;action&quot;: &quot;log-out&quot;}">Cerrar Sesión</a>
      </li>
    </ul>
  </li>
  </ul>
  ...
  <div class="btn-group-inverse">
    <button type="button" class="btn btn-submenu dropdown-toggle" data-toggle="dropdown">
            ...
            <span class="icon-chevron-down"></span> Recuperar playlists
    </button>
  ...
  <a href="vista-general-cuenta.php"><svg><use xlink:href="#icon-home"></use></svg> Vista general de la cuenta</a>
  </li>

                        
    
  <li id="submenu-item-edit-profile">
  <a href="editar-prefil.php"><svg><use xlink:href="#icon-edit"></use></svg> Editar perfil</a>
  </li>

                                        
    
  <li id="submenu-item-change-password">
  <a href="cambiar-contraseña.php"><svg><use xlink:href="#icon-locked"></use></svg> Cambiar contraseña</a>
  </li>
  ...
  <a href="dispositivos.php"><svg><use xlink:href="#icon-offline"></use></svg> Dispositivos offline</a>
  </li>
  ...
  <a href="recibos.php"><svg><use xlink:href="#icon-payment-history"></use></svg> Recibos</a>
  </li>

                        
    
  <li id="submenu-item-apps">
  <a href="apps.php"><svg><use xlink:href="#icon-apps"></use></svg> Apps</a>
  </li>

                        
    
  <li id="submenu-item-redeem">
  <a href="canjear.php"><svg><use xlink:href="#icon-redeem"></use></svg> Canjear</a>
  </li>
...
<div class="sidebar">
  ...
  <li id="submenu-item-edit-profile">
  <a href="editar-perfil.php"><svg><use xlink:href="#icon-edit"></use></svg> Editar perfil</a>
  </li>
  ...
  <div class="page-header">
    <h1>Recuperar playlists</h1>
  </div>

      <p class="alert alert-danger">
      Hubo un error al recuperar tu playlist eliminada. Por favor inténtalo de nuevo más tarde.
    </p>
                </div>
  ...
  <div class="container">
    <nav class="row">
        ...
        <h3 class="nav-title">Compañía</h3>
        <ul class="nav">
          
  <li>
    <a href="/hn/about-us/contact/" id="nav-link-about" data-ga-category="menu" data-ga-action="about">
      Acerca de
                </a>
  </li>
  ...
  <li>
    <a href="/hn/brands/" id="nav-link-brands" data-ga-category="menu" data-ga-action="brands">
      Marcas
                </a>
  </li>
  ...
  <li class="hidden-xs ">
    <a href="/hn/redirect/webplayerlink/?utm_medium=www_footer" id="nav-link-play" data-ga-category="menu" data-ga-action="play">
      Reproductor web
                </a>
  </li>

    <li class="visible-xs hidden-sm ">
    <a href="/hn/free/?utm_medium=www_footer" id="nav-link-free" data-ga-category="menu" data-ga-action="free">
      App móvil gratis
                </a>
  </li>
...
<li>
  <a href="https://www.facebook.com/Spotify">
    ...
    <nav class="row row-small">
      <div class="col-xs-9 col-md-7">
          ...
          <li>
            <a href="/hn/legal/">Legal</a>
          </li>
          <li>
            <a href="/hn/privacy/">Centro de privacidad</a>
          </li>
          <li>
            <a href="/legal/privacy-policy/">Política de Privacidad</a>
          </li>
          <li>
            <a href="/hn/legal/cookies-policy/">Cookies</a>
          </li>
          <li>
            <a href="/hn/legal/privacy-policy/#s3">Sobre los anuncios</a>
          </li>
            ...
            <div class="col-xs-3 col-md-5 text-right">
                <a class="market" href="/hn/select-your-country/" title="Click para cambiar de idioma">
          <div class="media">
            <div class="media-body media-middle">
              Honduras
            </div>
            <div class="media-right media-middle">
              <span class="media-object flag-icon flag-icon-hn"></span>
            </div>
          </div>
        </a>
  ...
  <script>
    $(function() {
      spweb.recoverPlaylists.init('Recuperada\x28s\x29');
    });
  </script>
