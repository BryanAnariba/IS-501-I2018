...
<head>
    ...
    <title>Dispositivos -Spotify</title>
...
<body class=" m-hn l-es page-account-offline-devices is-loggedin  reboot " cz-shortcut-listen="true">
          <noscript>
...
<li>
  ...
  <div class="btn-group-inverse">
    <button type="button" class="btn btn-submenu dropdown-toggle" data-toggle="dropdown">
              <svg><use xlink:href="#icon-offline"></use></svg>
            <span class="icon-chevron-down"></span> Dispositivos offline
    </button>
...
<div class="sidebar">
  ...
  <a href="canjear.php"><svg><use xlink:href="#icon-redeem"></use></svg> Canjear</a>
    ...
    <h1>Dispositivos offline</h1>
        ...
        No tienes ningún dispositivo offline
      </p>
